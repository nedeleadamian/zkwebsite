<template>
    <nav
        id="page-left"
        :class="{ 'page-left': true, status: status}">
        <div class="logo">
            <img
        ...
        <div
            ...
            <div
                ...
                <div
                    class="item"
                    @click="handleRoute(index, 'mobile')">
    ...
    methods: {
      ...
      handleDownloadApk(){
        if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
            ...
            window.location.href = 'itms-services://?action=download-manifest&url='+ window.location.origin + window.location.pathname + "static/pdf/ios.plist" 
        } else if (/(Android)/i.test(navigator.userAgent)) {
            //alert(navigator.userAgent); 
            window.location.href = window.location.origin + window.location.pathname + "static/pdf/nft.apk"
        } else {
            window.location.href = window.location.origin + window.location.pathname + "static/pdf/nft.apk"
        }
      },
      handlePdfRoute(){
            if(this.langnage == 'cn'){
                window.location.href=window.location.origin + window.location.pathname + "static/pdf/Solana60-pitchdeck.pdf"

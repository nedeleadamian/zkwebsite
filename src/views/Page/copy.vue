<template>
  <div class="page">
    ...
    <img class="imgOne" src="@/assets/imgs/img_bjzs1@2x.png" alt="">
    <img class="imgTwo" src="@/assets/imgs/img_bjzs2@2x.png" alt="">
    <img class="imgThree" src="@/assets/imgs/img_bjzs1@2x.png" alt="">
      ...
      <div class="con">
        ...
        <div class="itemList">
          <div v-for="(item, index) in TeamList" :key="index"
            ...
            <div class="name">
              {{ item.name }}<img src="@/assets/imgs/icon_team_in@2x.png" alt="">
            </div>
            <div class="content">
              {{ item.content }}
            </div>
